...
This is the quantization contract for `v0.1.0-rc.9`. The production artifact is
...
clamped SwiGLU `(alpha=1, beta=0, limit=10)`. v0.1.0-rc.9 applies a byte-gated patch
