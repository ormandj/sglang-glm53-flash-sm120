...
IMAGE=${IMAGE:-ghcr.io/ormandj/sglang-glm53-flash-sm120:v0.3.1}
PORT=${PORT:-8000}
...
# additional RAM for model loading and serving. Qualification enables it.
...
if [[ "$TP_SIZE" != 2 ]]; then
  echo "v0.3.1 is scoped to TP_SIZE=2" >&2
  exit 2
fi
