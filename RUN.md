# Running `v0.1.0-rc.23`

```bash
export IMAGE=sglang-glm53-flash-sm120:v0.1.0-rc.23
export MODEL_DIR=/models/GLM-5.3-Flash-W4A16-E4M3-K32-MSE
export CACHE_DIR=/srv/cache/sglang-glm53-flash-sm120-v13
./examples/serve-glm53-flash.sh
```

The default launcher is the intended TP2 qualification envelope: vision,
native adaptive MTP 5/1/6, native FlashInfer SM120 sparse MLA, FP8 KV, a
...
reuse an earlier candidate's cache with `v0.1.0-rc.23`.
