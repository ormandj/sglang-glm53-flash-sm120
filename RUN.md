# Running `v0.1.0-rc.24`

```bash
export IMAGE=sglang-glm53-flash-sm120:v0.1.0-rc.24
...
native adaptive MTP 5/1/6, TileLang SM120 DSA with raw FP8 KV, a
...
reuse an earlier candidate's cache with `v0.1.0-rc.24`.
