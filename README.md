...
Current candidate:
`git.home.corenode.com/homelab/sglang-glm53-flash-sm120-container:v0.1.0-rc.38`.
Local build name: `sglang-glm53-flash-sm120:v0.1.0-rc.38`.

**v0.1.0-rc.38 is a source candidate, not a qualified release.** Performance,
...
whole-layer ignore still selects BF16. Cache schema `v25` prevents reuse of
...
podman build \
  ...
  -t sglang-glm53-flash-sm120:v0.1.0-rc.38 .
```
