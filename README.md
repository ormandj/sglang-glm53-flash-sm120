...
Current candidate:
`git.home.corenode.com/homelab/sglang-glm53-flash-sm120-container:v0.1.0-rc.27`.
Local build name: `sglang-glm53-flash-sm120:v0.1.0-rc.27`.

**v0.1.0-rc.27 is a source candidate, not a qualified release.** Performance,
...
podman build \
  ...
  -t sglang-glm53-flash-sm120:v0.1.0-rc.27 .
```
