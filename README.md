...
Current candidate:
`git.home.corenode.com/homelab/sglang-glm53-flash-sm120-container:v0.1.0-rc.59`.
Local build name: `sglang-glm53-flash-sm120:v0.1.0-rc.59`.

**v0.1.0-rc.59 is a source candidate, not a qualified release.** Performance,
...
whole-layer ignore still selects BF16. Cache schema `v46` prevents reuse of
...
prenorm and fused post/pre paths. v0.1.0-rc.59 retains the same bounded
...
compiled DSA gate output, and paged-MQA logits are the v0.1.0-rc.59 runtime
candidate.
...
podman build \
  ...
  -t sglang-glm53-flash-sm120:v0.1.0-rc.59 .
```
