...
Current release: `v0.1.0-rc.66` with the W4A16-K32 + FP8-attention
MIXED_PRECISION artifact. Qualified image (internal build name
`sglang-glm53-flash-sm120:v0.1.0-rc.66`):

```text
ghcr.io/ormandj/sglang-glm53-flash-sm120:v0.1.0-rc.66
```
...
podman build \
  ...
  -t sglang-glm53-flash-sm120:v0.1.0-rc.66 .
```
