...
Current release: `v0.1.1-rc.8` for the W4A16 NVFP4 K32 experts + FP8
weight-only checkpoint. Source candidate, not yet built or qualified
(internal build name
`sglang-glm53-flash-sm120:v0.1.1-rc.8`):

```text
ghcr.io/ormandj/sglang-glm53-flash-sm120:v0.1.1-rc.8
```
...
Measured results below were qualified on `v0.1.0`. `v0.1.1-rc.8`
...
podman build \
  ...
  -t sglang-glm53-flash-sm120:v0.1.1-rc.8 .
```
