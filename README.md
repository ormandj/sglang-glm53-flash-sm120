...
Current candidate:
`git.home.corenode.com/homelab/sglang-glm53-flash-sm120-container:v0.1.0-rc.61`.
Local build name: `sglang-glm53-flash-sm120:v0.1.0-rc.61`.

**v0.1.0-rc.61 is a source candidate, not a qualified release.** Performance,
...
prenorm and fused post/pre paths. v0.1.0-rc.61 retains the same bounded
...
compiled DSA gate output, and paged-MQA logits are the v0.1.0-rc.61 runtime
candidate.
...
podman build \
  ...
  -t sglang-glm53-flash-sm120:v0.1.0-rc.61 .
```
